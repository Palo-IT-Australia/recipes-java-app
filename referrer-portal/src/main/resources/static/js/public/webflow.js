...
/***/ function(module, exports, __webpack_require__) {
	...
	Webflow.define('maps', module.exports = function($, _) {
	  ...
	  var apiKey = 'AIzaSyDzefQOQ-xmqMjvwQSNj1M8DfXo8hlcjYk';
...
Webflow.require('ix').init([
  ...
  {"slug":"feature-hover-procedures","name":"Feature Hover - Procedures","value":{"style":{},"triggers":[{"type":"hover","selector":".feature-image","descend":true,"stepsA":[{"transition":"transform 500ms ease 0ms","scaleX":1.1,"scaleY":1.1,"scaleZ":1}],"stepsB":[{"transition":"transform 500ms ease 0ms","scaleX":1,"scaleY":1,"scaleZ":1}]},{"type":"hover","selector":".wrapper-feature-procedures","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"display":"block","opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none","opacity":0,"transition":"opacity 500ms ease 0ms"}]},{"type":"hover","selector":".wrapper-default","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}]}]}},
  {"slug":"feature-hover-specialists","name":"Feature Hover - Specialists","value":{"style":{},"triggers":[{"type":"hover","selector":".feature-image","descend":true,"stepsA":[{"transition":"transform 500ms ease 0ms","scaleX":1.1,"scaleY":1.1,"scaleZ":1}],"stepsB":[{"transition":"transform 500ms ease 0ms","scaleX":1,"scaleY":1,"scaleZ":1}]},{"type":"hover","selector":".wrapper-feature-specialists","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"display":"block","opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none","opacity":0,"transition":"opacity 500ms ease 0ms"}]},{"type":"hover","selector":".wrapper-default","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}]}]}},
  {"slug":"feature-hover-clinics","name":"Feature Hover - Clinics","value":{"style":{},"triggers":[{"type":"hover","selector":".feature-image","descend":true,"stepsA":[{"transition":"transform 500ms ease 0ms","scaleX":1.1,"scaleY":1.1,"scaleZ":1}],"stepsB":[{"transition":"transform 500ms ease 0ms","scaleX":1,"scaleY":1,"scaleZ":1}]},{"type":"hover","selector":".wrapper-feature-clinics","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"display":"block","opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none","opacity":0,"transition":"opacity 500ms ease 0ms"}]},{"type":"hover","selector":".wrapper-default","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}]}]}},
  {"slug":"feature-hover-technology","name":"Feature Hover - Technology","value":{"style":{},"triggers":[{"type":"hover","selector":".feature-image","descend":true,"stepsA":[{"transition":"transform 500ms ease 0ms","scaleX":1.1,"scaleY":1.1,"scaleZ":1}],"stepsB":[{"transition":"transform 500ms ease 0ms","scaleX":1,"scaleY":1,"scaleZ":1}]},{"type":"hover","selector":".wrapper-feature-technology","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"display":"block","opacity":0,"transition":"opacity 500ms ease 0ms"},{"display":"none","opacity":0,"transition":"opacity 500ms ease 0ms"}]},{"type":"hover","selector":".wrapper-default","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}]}]}},
...
function closeTabs() {
    ...
    $.data($(document).find(".w-tabs")[0],".w-tabs").current = null;
    $.data($(document).find(".w-tabs")[1],".w-tabs").current = null;
}

function toggleTabs() {
    $(".w-tab-link").each(function() {
        var elem = $(this);
        var val = elem.attr("data-w-tab-open");
        if (val) {
            elem.attr("data-w-tab-open", "");
            setTimeout(function () {
                closeTabs();
            }, "100");
        } else {
            elem.attr("data-w-tab-open", "Tab 1");
        }
    });
}

function toggleFooter() {
    var elem = $(".footer-inner");
    if(elem.hasClass("footer-active")) {
        elem.removeClass("footer-active");
        $('.toggleText').text('Show');
    }
    else {
        elem.addClass("footer-active");
        $(".toggleText").addClass("footer-active");
				$("html, body").animate({
...
function closeDropDown() {
    ...
    $.data($(document).find(".w-dropdown-list")[0],".w-dropdown-list").current = null;
}

function goFinder(elm) {
    var pdiv = $($(elm).closest(".w-form"));
    var adr = $(pdiv.find("input")[0]).val();
    var mod = $(pdiv.find("select")[0]).val();
    var url = "/wps/portal/i-med/Home/clinics/!ut/p/z1/04_Sj9CPykssy0xPLMnMz0vMAfIjo8ziDR0NnQ29TAy9_X0tLQwcjT3MXdyMPYwDTQz1C7IdFQEW8mgz/?";   // Change page url accordingly
    if(adr.length > 0) {
        var url = url + "adr=" + adr;
        if(mod.length > 0){
            url = url + "&mod=" + mod;
...
function openSiteSearch(sword){
    var url = "/wps/portal/i-med/Home/sitesearch/!ut/p/z1/04_Sj9CPykssy0xPLMnMz0vMAfIjo8ziDR0NnQ29TAy9LSx8nAwcvUxMgyycA4y8fQ30C7IdFQFLNl4C/?";
    window.location.href=url+"searchWord="+sword;
}
